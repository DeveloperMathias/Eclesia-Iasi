...
const Navbar = (props) => {
    ...
    return (
        <Flex w="100%" height="20" bg={props.bg} p="10px" alignItems="center">
            <Image boxSize="65px" src={icon} alt="logo" />
            <Text color="red.600" fontSize={ isNotMobile ? { xl: "2xl", md: "xl", sm: "md" } : "1em"} fontWeight="medium" ml="1rem">Biserica Eclesia Iași</Text>
            <Spacer></Spacer>
            ...
            <DrawerOverlay />
            <DrawerContent>
                <DrawerCloseButton color="red.600" _active={{
                        transform: "scale(0.95)",
                        borderColor: "red.400"
